...
def register_handlers(bot):
    ...
    def handle_start(message: types.Message):
        ...
        subscribe_button = types.InlineKeyboardButton(text="➡️ Перейти к каналу", url=f"https://t.me/{CHANNEL_ID.lstrip('@')}")
        ...
        try:
            ...
            with open('welcome.jpg', 'rb') as photo:
                bot.send_photo(message.chat.id, photo, caption=welcome_text, reply_markup=keyboard)
            ...
            if chat_member.status in ['member', 'administrator', 'creator']:
                ...
                try:
                    with open('tincture.jpg', 'rb') as photo:
                        bot.send_photo(user_id, photo, caption=coupon_text)
                except FileNotFoundError:
                    bot.send_message(user_id, coupon_text)
