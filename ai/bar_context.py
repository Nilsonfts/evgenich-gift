...
def get_location_info() -> dict:
    ...
    return {
        ...
        "evgenich_msk": {
            "name": "Евгенич на Пятницкой",
            "address": "ул. Пятницкая, 30, Москва",
            "metro": "Новокузнецкая, Третьяковская",
            "phone": "+7 (495) 123-45-67",
            "coords": "55.741461, 37.628987"
        },
        "evgenich_msk_tsvetnoj": {
            "name": "Евгенич на Цветном бульваре",
