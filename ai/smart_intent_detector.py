...
class SmartIntentDetector:
    ...
    def __init__(self):
        ...
        self.intent_patterns = {
            ...
            "menu": {
                "keywords": [
                    "меню", "еда", "кухня", "блюда", "закуски",
                    "настойки", "напитки", "коктейли", "цены",
                    "чебурек", "драник", "оливье", "пиво",
                ],
                "phrases": [
                    "что есть", "что подают", "можно поесть",
                    "какие настойки", "сколько стоит", "какое меню",
                ],
                "priority": 3,
            },
            "karaoke": {
