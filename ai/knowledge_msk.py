...
_SYNONYMS = {
    ...
    "обеды": ["обед", "обеды", "бизнес-ланч", "бизнес ланч", "ланч", "комплекс", "комплексный", "дневное меню", "школьное меню", "как в школе", "обеды от евгенича", "столовка", "поесть днем", "поесть днём", "пообедать"],
