    ...
    *,
    ...
    if is_group_chat:
        extended_context += (
            ...
            "ВАРИАНТ 1 - Гость говорит что УЖЕ ОСТАВИЛ ЗАЯВКУ (на сайте или через кнопку):\n"
            "→ Похвали и успокой: «Отлично! 👍 Наш отдел бронирования уже видит твою заявку и обязательно свяжется с тобой. Обычно отвечают быстро, максимум 30-40 минут. Всё будет круто! 😊»\n\n"
            ...
            "   Там кнопка ЗАБРОНИРОВАТЬ - жми на неё, откроется мой личный чат с формой. Заполняй форму, и наш отдел бронирования свяжется с тобой! 😊\n\n"
            "   Обычно отвечают в течение 30 минут»\n\n"
