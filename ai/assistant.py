    ...
    *,
    ...
    if is_group_chat:
        extended_context += (
            ...
            "→ ЧТО ДОНЕСТИ: Объясни где закрепленное сообщение 📌, там кнопка, откроется личный чат, заполнить форму, отдел свяжется (~30 мин)\n"
            "→ ТОНАЛЬНОСТЬ: Дружелюбная, понятная, простая\n"
            "→ ПРИДУМАЙ СВОЙ ТЕКСТ! Варьируй формулировки:\n"
            "   • \"Гляди в самый верх чата - там закреп 📌 Жми кнопку, заполняй форму, и ребята из отдела напишут тебе!\"\n"
            "   • \"Смотри закрепленное сообщение вверху 📌 Там кнопочка есть - нажимай, откроется форма бронирования. Девчонки свяжутся минут через 30 😊\"\n"
            "   • \"Вверху чата есть закреп со значком 📌 Там кнопка ЗАБРОНИРОВАТЬ - тапай на неё, заполни форму, и наш отдел скоро напишет!\"\n\n"
            ...
            "→ ЧТО ДОНЕСТИ: Объясни что это самое верхнее сообщение в чате, прокрутить вверх, значок 📌\n"
            ...
            "   • \"Прокрути чат в самое начало - там будет сообщение с булавкой 📌 Это оно!\"\n"
