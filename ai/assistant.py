...
def create_system_prompt(updates_string: str, user_concept: str = "evgenich") -> str:
    ...
    return (
        ...
        f"3. Спрашивает про бар → Расскажи коротко, задай встречный вопрос\n"
        f"4. Делится впечатлениями → Порадуйся вместе! Спроси подробнее\n"
        f"5. Странный вопрос → Пошути добродушно 😄\n\n"
        f"# СТРУКТУРА ОТВЕТА\n"
