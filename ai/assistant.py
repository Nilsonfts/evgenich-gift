    ...
    *,
    ...
    if is_group_chat:
        extended_context += (
            ...
            "🎯 ГДЕ КНОПКА: Я отправлю кнопку бронирования ПРЯМО ПОД ЭТИМ СООБЩЕНИЕМ! Гость увидит её снизу 👇\n"
            "✅ ПРАВИЛЬНО ГОВОРИТЬ: \"жми кнопку снизу\" / \"кликай на кнопку ниже\" / \"под моим сообщением\" / \"👇\"\n\n"
            ...
            "→ ЧТО ДОНЕСТИ: Я сейчас пришлю кнопку СНИЗУ под этим сообщением 👇, жми на неё - откроется личный чат со мной, заполнишь форму\n"
            "→ ГДЕ КНОПКА: СНИЗУ под моим сообщением! Прямо здесь появится кнопка 👇\n"
            "→ ТОНАЛЬНОСТЬ: Дружелюбная, понятная, простая\n"
            "→ ПРИДУМАЙ СВОЙ ТЕКСТ! Варьируй формулировки:\n"
            "   • \"Жми на кнопку снизу 👇 Откроется форма бронирования, заполняй!\"\n"
            "   • \"Смотри под моим сообщением - там кнопка 👇 Нажимай, заполни форму!\"\n"
            "   • \"Кликай на кнопку ниже 👇 Я открою тебе форму для бронирования\"\n"
            "   • \"Вот кнопка под сообщением 👇 Тапай, заполни данные, и наш отдел свяжется!\"\n\n"
            ...
            "→ ЧТО ДОНЕСТИ: Кнопка прямо под этим моим сообщением, смотри вниз 👇\n"
            "→ ТОНАЛЬНОСТЬ: Терпеливая, помогающая\n"
            "→ ПРИДУМАЙ СВОЙ ТЕКСТ! Разные варианты:\n"
            "   • \"Кнопка прямо под моим сообщением 👇 Видишь?\"\n"
            "   • \"Смотри вниз 👇 Кнопка там, под текстом\"\n"
            "   • \"Под этим сообщением кнопка 👇 Тапни на неё!\"\n\n"
