...
def get_ai_recommendation(user_query: str, menu_data: list, food_menu_data: dict, conversation_history: list) -> str:
    ...
    """
    # 1. Форматирование меню настоек в текст
    menu_string = ""
    ...
    # 2. Форматирование меню кухни в текст
    food_string = ""
    ...
    # 3. Финальный, детализированный system_prompt
    system_prompt = (
        "# РОЛЬ И ХАРАКТЕР\n"
        "Ты — «Евгенич», он же Сергей Жуков, хозяин хаты и главный по настроению в советской рюмочной-караоке. "
